...
%*****************************************************************************************************
% Radial Arm Maze Firt arm choice bias
% Last two non experimental days only (days 13 & 15)
% Group 4 Muscimol test 1/22/16
...
% total arm choices 
averagematrix=(data([106:112,120:125],[1:4]))
average=reshape(averagematrix,[],1);
average(average==1) = 0;
average(average==2) = 45;
average(average==3) = 90;
