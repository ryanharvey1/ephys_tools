%% Radial Arm Maze 
% Group 3 Probe Trial 12/8/15, ALL ARM CHOICES INCLUDED

% Conversion from arms to degrees
% RT08
w=[5 2 8 7 5 3 8 5 2 5 7 5 1 6 4 5 8 5 8 5 2 6 4 8 5 1 5];
w(w==1) = 0;
w(w==2) = 45;
w(w==3) = 90;
w(w==4) = 135;
...
y(y==8) = 315;
% RT02
g=[6 3 1 3 5 7 6 2 5 6 4 5 8 6 3];
g(g==1) = 0;
g(g==2) = 45;
g(g==3) = 90;
g(g==4) = 135;
...
% Normalized around 0 for rats trained around 4,6
average=[5 2 8 7 5 3 8 5 2 5 7 5 1 6 4 5 8 5 8 5 2 6 4 8 5 1 5 1 7 3 5 2 4 2 4 1 2 7 5 3 2 7 5 7 1 3 2 6 1 2 8 1 4 2 7];
average(average==1) = 0;
...
fprintf('\t\t\t\t\tALPHA\tBETA\tGAMMA\tAVERAGE\n')
...
fprintf('Mean resultant vector:\t\t\t%.2f\t%.2f\t%.2f\t%.2f\n', circ_rad2ang([alpha_bar beta_bar gamma_bar average_bar]))
...
fprintf('Median:\t\t\t\t\t%.2f\t%.2f\t%.2f\t%.2f\n', circ_rad2ang([alpha_hat beta_hat gamma_hat average_hat]))
...
fprintf('R Length:\t\t\t\t%.2f \t%.2f\t%.2f\t%.2f\n',[R_alpha R_beta R_gamma R_average])
...
fprintf('Variance:\t\t\t\t%.2f \t%.2f\t%.2f\t%.2f\n',[S_alpha S_beta S_gamma S_average])
...
fprintf('Standard deviation:\t\t\t%.2f\t%.2f\t%.2f\t%.2f\n',[s_alpha s_beta s_gamma s_average])
fprintf('Standard deviation 0:\t\t\t%.2f\t%.2f\t%.2f\t%.2f\n',[s0_alpha s0_beta s0_gamma s0_average])
...
fprintf('Skewness:\t\t\t\t%.2f \t%.2f\t%.2f\t%.2f\n',[b_alpha b_beta b_gamma b_average])
...
fprintf('Kurtosis:\t\t\t\t%.2f \t%.2f\t%.2f\t%.2f\n',[k_alpha k_beta k_gamma k_average])
...
fprintf('Rayleigh Test:\t\t\t\t%.2f \t%.2f\t%.2f\t%.2f\n',[p_alpha p_beta p_gamma p_average])
...
fprintf('Omnibus Test:\t\t\t\t %.2f \t%.2f\t%.2f\t%.2f\n',[o_alpha o_beta o_gamma o_average])
...
fprintf('Rao Spacing Test:\t\t\t%.2f \t%.2f\t%.2f\t%.2f\n',[p_alpha p_beta p_gamma p_average])
...
fprintf('V Test (r = 0):\t\t\t\t %.2f\t%.2f\t%.2f\t%.2f\n',[p_alpha p_beta p_gamma p_average])
