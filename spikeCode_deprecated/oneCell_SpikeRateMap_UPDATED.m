...
%       - GridScore
% 
% Created by Ben C Jan 2014; Updated August 2015

% identify path to data files
path = '/Users/RyanHarvey/dropbox/MATLAB/Cell analysis/';
ReadData = FindFiles('bc217_s03_TT1_u2.txt', 'StartingDirectory', path);

% messing around trying to loop it (5/2/16)
...
figure (), plot(dataVEL(:,1),dataVEL(:,2),'LineWidth',2,'color',[0,0,0]+0.8); 
axis square tight
hold on
...
% 
% plot filled and smoothed rate map 
% figure(3), h = pcolor(FilledRateMatrix);
% axis square tight
% hold on
% colorbar;
% box off
...
% data to retain
keep SmoothRateMap FilledRateMatrix
