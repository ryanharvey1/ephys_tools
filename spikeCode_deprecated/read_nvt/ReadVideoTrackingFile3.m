function [ VTfile ] = ReadVideoTrackingFile3( input_args )
...
% Updated by Ryan Harvey, Psychology Department University of New Mexico 8/2016
...
cd(input_args);
filename = char(FindFiles('VT1.nvt'));
finfo=dir(filename);
