...
path = '/Users/RyanHarvey/Documents/Pas';
...
FRxHD = plot(BinsAngle3,BinsNbSpikes,'LineWidth',2,'color','k');
axis tight;
hold on
xlim ([0 360]);
box off
...
saveas(FRxHD,[filepath filesep filename '_FRxHD.jpg']);
...
%     save([filepath filesep filename '_HD_Properties.mat']);    
    ...
    close all    
    keep('path', 'ReadData', 'BinsAngle3', 'BinsNbSpikes', 'BinsAngle');
end
