...
// all stuff above is already defined. only below is extra for VT files

const int IndexExtractedX = 1;
const int IndexExtractedY = 2;
const int IndexExtractedAngle = 3;
const int IndexTargets = 4;
const int IndexPoints = 5;
