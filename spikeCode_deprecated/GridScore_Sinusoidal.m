function [gridout] = GridScore_Sinusoidal(SpatialAutoCorr,nBins)
...
rGridScore=zeros(length(list),5);
% rSinuScores = [];
GS1=zeros(length(list),1);
SinuGrid=zeros(length(list),1);
...
%     rSinuScores(i,:)=rALL;
    ...
    GS1(i,1)=minGroup1_GS - maxGroup2_GS;
