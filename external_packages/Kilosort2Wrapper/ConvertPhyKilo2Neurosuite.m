function ConvertPhyKilo2Neurosuite(varargin)
%
% ###
% .
% +-- _folder(basename)
...
addParameter(p,'basepath',cd)
addParameter(p,'ks_basepath',[])
parse(p,varargin{:})

kilosort2 = p.Results.kilosort2;
basepath = p.Results.basepath;
savepath = p.Results.basepath;
ks_basepath = p.Results.ks_basepath;
