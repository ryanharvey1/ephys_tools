...
ops.fbinary             = fullfile(fpath, 'KiloSortBinary.dat'); % will be created for 'openEphys'		
...
ops.Nfilt               = 96*2; % number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
...
ops.nfullpasses         = 10;    % number of complete passes through data during optimization (6)		
...
ops.nannealpasses    = 6;            % should be less than nfullpasses (4)		
...
ops.loc_range       = [3  0];  % ranges to detect peaks; plus/minus in time and channel ([3 1])		
...
ops.ForceMaxRAMforDat   = 10e9; % maximum RAM the algorithm will try to use; on Windows it will autodetect.
