classdef (Sealed) Variable
    ...
    %   $Revision: 1.1.6.3 $    $Date: 2010/11/01 19:22:05 $
    ...
    methods
        ...
        function originalDataClass = get.Class(this)
            % The returned value is the class of the original data.
            originalDataClass = class(this.OriginalData);
        end
    end
end
