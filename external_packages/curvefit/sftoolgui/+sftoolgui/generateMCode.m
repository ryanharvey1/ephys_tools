...
%   $Revision: 1.1.6.6 $    $Date: 2010/09/24 14:30:00 $
...
% We will wrtie to the editor if it is available AND we have not been supplied
% with a file name
...
if isWriteToEditor
    ...
    % otherwsie these get added to the code
...
[filename, path] = uiputfile( filespec, 'Generate Code' );
