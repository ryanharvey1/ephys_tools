classdef Panel < handle
    ...
    %   $Revision: 1.1.6.4.2.1 $    $Date: 2011/07/18 00:30:55 $ 
    ...
    methods
        function this = Panel(parent)
            ...
            this.ResizeListener = curvefit.listener(this.HUIPanel, ...
                'SizeChange', iMakeResizeCallback(this));
        end
