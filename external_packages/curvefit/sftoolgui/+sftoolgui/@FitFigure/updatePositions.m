...
%updatePositions Positions FitFigure subpanels
%
%   updatePositions(FitFig) updates the position of the items within the
%   FitFigure.

%   Copyright 2008-2011 The MathWorks, Inc.
%   $Revision: 1.1.6.4 $    $Date: 2011/05/09 00:40:20 $
