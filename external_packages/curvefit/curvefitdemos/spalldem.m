...
% This is a quick introduction to the B-form, and to commands in Curve
% Fitting Toolbox(TM) that work on the B-form.

% Copyright 1987-2010 The MathWorks, Inc.
% $Revision: 1.1.6.4 $  $Date: 2010/10/25 15:54:45 $
