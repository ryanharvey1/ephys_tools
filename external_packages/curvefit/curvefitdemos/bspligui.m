...
%   or simply closing the window for the GUI.
%
%   See also BSPLINE, SPCOL.

%   Copyright 1987-2010 The MathWorks, Inc.
%   $Revision: 1.1.6.6 $  $Date: 2010/10/25 15:54:37 $
...
case 'start'
  ...
  'Also shown are the 1st, 2nd, and 3rd derivative of the B-spline.',...
   ...
   uicontrol('Units','normalized','Position',[wl, lifts, ww, hh], ...
    ...
    uimenu(h1,'Label','&Spline Commands', ...
        'Callback', @iHelpSplineCommands );
