...
%   $Revision: 1.1.6.2 $  $Date: 2010/10/08 16:37:51 $
...
for lw=1:itermax
   if test 
      figure
      fnplt(sp); 
      title( sprintf( 'Approximation at beginning of iteration %s', num2str(lw) ) )
      hold on; 
...
fprintf('Failed to reach tolerance %8f in %3g iterations\n',tol,itermax)
