classdef (Sealed = true) sfit < fittype
    ...
    %   $Revision: 1.1.6.6.4.1 $  $Date: 2011/07/18 00:30:45 $
    ...
    methods(Access = private)
        ...
        function obj = constructFromManyArguments( obj, model, varargin )
            ...
            error( nargchk( numParams, Inf, length( varargin ), 'struct') );
...
% TODO: Why is this size check needed? It is in the cfit constructor, but if it
% is false then we never compute Rinv and surely we should warn or error at that
% point.
