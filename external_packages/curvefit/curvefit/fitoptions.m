...
%   $Revision: 1.10.2.12 $  $Date: 2010/10/08 16:36:53 $
...
if isa(varargin{1},'curvefit.basefitoptions') 
    ...
    ind = strmatch(lower(varargin{1}),fittypes, 'exact');
    if isempty( ind )
...
methods = {'none', 'smoothingspline',...
        ...
        'biharmonicinterpolant', 'lowessfit'};
...
ReturnToken = ['no';'sm';'ne';'li';'pc';'cu';'ll';'nl';'bh';'lo'];
