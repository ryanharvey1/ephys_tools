...
%   $Revision: 1.26.2.23 $  $Date: 2011/05/09 00:39:26 $
...
%
% NOTE: If the inputs x and y are empty then the outputs will be x is
% empty and y = NaN.
...
%---------------------------------------------------------
function f = iGriddata( pp, x, y )

f = griddata( pp.XData, pp.YData, pp.ZData, x, y, pp.Method );
