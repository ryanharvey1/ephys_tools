classdef LowessFit
    ...
    %   $Revision: 1.1.6.5 $    $Date: 2010/11/08 02:16:20 $ 

    properties(SetAccess = 'public', GetAccess = 'public')
        % Degree   Degree of the polynomial used in the local regressions.
    ...
    methods(Access = 'private')
            ...
            switch obj.Degree
                ...
                case 2
                    ...
                    elseif nDim == 2
                        ...
                        throwAsCaller( MException( 'curvefit:LowessFit:InvalidDimension', ...
                            'For DEGREE==2, X must have one or two columns.' ) );
                    end
                otherwise
                    throwAsCaller( MException( 'curvefit:LowessFit:InvalidDegree', ...
                        'Degree must be zero, one or two.' ) );
            end
        end
        ...
        function obj = parseSpan( obj )
            ...
            if obj.NLocal > nData
                throwAsCaller( MException( 'curvefit:LowessFit:InsufficientData', ...
                    'Insufficient data for lowess model of degree %d.', obj.Degree ) );
            end
        end
        ...
        function obj = parseRobust( obj )
            ...
            switch lower( obj.Robust )
                ...
                otherwise
                    throwAsCaller( MException( 'curvefit:LowessFit:InvalidRobust', ...
                        'Invalid value for robust: %s', obj.Robust ) );
            end
        end
