function [speed_grid,speedVec,speed] = speed_map(posx,posy,nbins,sampleRate)
...
maxSpeed = 60; speed(speed>maxSpeed) = maxSpeed; %send everything over 50 cm/s to 50 cm/s
