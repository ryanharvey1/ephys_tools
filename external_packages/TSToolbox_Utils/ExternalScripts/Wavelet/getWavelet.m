% [ wave, f, t, coh, phases, raw, coi, scale, period, scalef ] = getWavelet( x, Fs, fMin, fMax, nbins, mother, scaling, graphics )
%
% [ wave, f, t, coh, phases, raw, coi, scale, period, scalef ] = getWavelet( x, Fs, fMin, fMax, nbins, scaling, graphics )
%
% x:        
...
% frequency ranges and calculate the spiking rate frequency/phase maps /DONE 11mar13/
