%function [excPairs,inhPairs,pkTimes,trTimes,pkStr,trStr,hiBound,loBound] = FindSynapse(cch,varargin)

function [synLat,synStrZ,synStrR,sigBounds] = FindSynapse(cch,varargin)
