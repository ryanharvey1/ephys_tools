function [synLat,synStrZ,synStrR,sigBounds] = FindSynapse_SameShank(cch,varargin)
...
[synLat,synStrZ,synStrR,sigBounds] = FindSynapse(cchCor,'synWin',synWin,'bins',bins,'alpha',alpha,'excSigWin',excSigWin,'inhSigWin',inhSigWin,'convWin',window);
