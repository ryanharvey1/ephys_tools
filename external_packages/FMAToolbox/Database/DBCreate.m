...
try
   ...
   error('FMAToolbox:DBCreate:cannotCreateDB',['Could not create database ''' database '''. This database might already exist or you\nmay not have the appropriate access rights, in which case you may want to ask your DBA\nto create an empty database for you, and then use <a href="matlab:help DBCreateTables">DBCreateTables</a> to create the actual\ntables in the database.']);
end
