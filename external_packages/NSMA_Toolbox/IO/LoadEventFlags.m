function [evtsd, ts, param1, param2, param3, evstring] = LoadEventFlags(fname)
%
%  [evtsd, ts, param1, param2, param3, evstring] = LoadEventFlags(fname)
%
% load a Cheetah_NT event flag file 
%  
