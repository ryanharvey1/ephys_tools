...
% 
% Principal Component Analysis of normalized and standardized waveforms from a
...
%
% INPUT: 
%      cv ... nSamp x nSamp wavefrom covariance matrix (unnormalized) (as
%             returned e.g. by waveStats
%
% OUTPUT:
