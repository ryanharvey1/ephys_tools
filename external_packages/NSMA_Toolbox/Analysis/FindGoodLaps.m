function [startgoodlaps, stopgoodlaps, laps]=FindGoodLaps(V_rest,laps,edgethresh,completeprop,plotlaps,posbins)
...
bottomend=min(Data(V_rest));
topend=max(Data(V_rest));
