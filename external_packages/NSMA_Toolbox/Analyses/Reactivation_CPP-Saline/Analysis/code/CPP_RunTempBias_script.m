...
for irat = 1:length(ratlist)
    ...
    filename = [outputDir, filesep, 'Run',runNrStr,'_', group,'_Bias_results_', ratlist{irat}, '_', num2str(binsize_S *20), 'ms'];
...
filename = [outputDir, filesep, 'Run',runNrStr,'_', group,'_Area_', ratlist{irat}, '_', num2str(binsize_S *20), 'ms'];
fprintf('\n writing variable areaMall to file %s in dir %s' ,filename,pwd)
save(filename,'areaMall','NCellsTotal');
