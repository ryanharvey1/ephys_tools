...
plotRats = 1;   % set to 1 for plotting Regression plots for each individual rat, 0 for all rats pooled together
...
if ~CPP
    ...
    run_label = 'CPP';
    indir = 'T:\CPP1\JessicasData\Analysis\out\TempBias_30Spikes_Binsize100ms_CPP_15min';
...
for jj = 1:length(ratlist)  
    ...
    filename = [runNrStr ratlist{jj} '_bias_results' '.mat'];
    load(filename);
    fprintf('\n\n=========================== %s ============================\n', filename);
