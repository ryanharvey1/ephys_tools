function GammaPowerVsTime(eeg_tsd, binsize_sec, epochs, xlims)

% GammaPowerVsTime  Plots gamma power over time
%
% GammaPowerVsTime(eeg_tsd, binsize_sec, epochs, xlims)
%
% INPUTS:
...
% filter for gamma
Z = Filter4Ripples(eeg_tsd,20,60);   % Z is the NOT-SUBSAMPLED filtered eeg tsd (20-60Hz = Gamma, 100-300Hz = ripples)
