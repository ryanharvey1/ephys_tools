...
function postprocessMClust_v9_batch(Laura,Ryan,figures,rats)
...
for irats=1:length(rats)
    ...
    for I=1:length(structdir) % 1 TO # OF FILES IN DIR
        ...
        postprocessMClust_v9working2(path,track_length,linear_track,figures); % CALL POSTPROCESS FUNCTION
    end
end
