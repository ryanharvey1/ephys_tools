...
path=('D:\Place_Cell_Data\PAE_Rat\RH16\2016-09-04_17-03-01'); % enter path to raw data (non-pfile) 

% length of the track 90 (pre 7/14/16) or 120 (7/14/16 and on)
track_length = 120; % in cm 
...
nBinsx = round(track_length/4); %~4x4cm bin size ************** for arena, comment out and make 24
% nBinsx = 30; % ~4x4cm assuming a ~120cm track 
nBinsy = 2; % *********************** for arena, comment out and make 24
