...
data_video_smoothvelfilt = data_video_smoothfilt((vel_cmPerSec >= 2),:); % 5cm/sec is used by Stensola et al 2012
...
MinY = nanmin(data_video_smoothvelfilt(:,3));
MaxY = nanmax(data_video_smoothvelfilt(:,3));
MinX = nanmin(data_video_smoothvelfilt(:,2));
MaxX = nanmax(data_video_smoothvelfilt(:,2));
